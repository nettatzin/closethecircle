...
export const energyOptions = [
  { id: 'low_key', icon: '🪶', label: 'Low key', time: 'Minutes to an hour' },
  { id: 'hands_on', icon: '🔥', label: 'Hands-on', time: 'A few hours' },
  { id: 'deep_work', icon: '💪', label: 'Deep work', time: 'Ongoing commitment' }
];
