...
const en = {
  ...
  mode_my_list: 'My List',
  menu_open: 'Open menu',
  menu_close: 'Close menu',
  my_list_tab_initiatives: 'Initiatives',
  my_list_tab_artworks: 'Artworks',
  my_list_empty_initiatives_title: 'Your list is empty',
  my_list_empty_initiatives_body: "Save the initiatives that resonate with you — come back and close their circle when you're ready.",
  my_list_empty_artworks_title: 'No saved artworks yet',
  my_list_empty_artworks_body: 'Save the artworks that stayed with you from the exhibition.',
  start_exploring_artworks: 'Browse artworks',
...
const he: typeof en = {
  ...
  mode_my_list: 'הרשימה שלי',
  menu_open: 'פתח תפריט',
  menu_close: 'סגור תפריט',
  my_list_tab_initiatives: 'יוזמות',
  my_list_tab_artworks: 'יצירות',
  my_list_empty_initiatives_title: 'הרשימה שלך ריקה',
  my_list_empty_initiatives_body: 'שמרו את היוזמות שמדברות אליכם — חזרו לסגור את המעגל שלהן כשתהיו מוכנים.',
  my_list_empty_artworks_title: 'עדיין לא שמרתם יצירות',
  my_list_empty_artworks_body: 'שמרו את היצירות שנשארו איתכם מהתערוכה.',
  start_exploring_artworks: 'לגלישה ביצירות',
