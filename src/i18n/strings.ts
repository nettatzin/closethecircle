...
const en = {
  ...
  cost_free: 'Free',
  cost_donation_based: 'Donation-based',
  cost_paid: 'Paid',
  audience_families: 'Families',
  audience_professionals: 'Professionals',
  audience_students: 'Students',
  audience_all_ages: 'All ages',
  theme_back_to_nature: 'Back to Nature',
  theme_everyday_circle: 'Everyday Circle',
  theme_healing_through_design: 'Healing Through Design',
  values_label: 'Values',
...
const he: typeof en = {
  ...
  impact_label: 'השפעה',
  format_in_person: 'פיזי',
  format_online: 'אונליין',
  format_hybrid: 'משולב',
  cost_free: 'חינם',
  cost_donation_based: 'בתרומה',
  cost_paid: 'בתשלום',
  audience_families: 'משפחות',
  audience_professionals: 'אנשי מקצוע',
  audience_students: 'סטודנטים',
  audience_all_ages: 'לכל הגילאים',
  theme_back_to_nature: 'חזרה לטבע',
  theme_everyday_circle: 'מעגל היומיום',
  theme_healing_through_design: 'ריפוי דרך עיצוב',
  values_label: 'ערכים',
